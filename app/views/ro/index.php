    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-body">
            <div class="row">
              <div class="col-sm-6"> 
                <form action="<?= base_url; ?>/RO/importExcel" enctype="multipart/form-data" method="POST" role="form">
                  <div class="row">
                    <div class="col-xs-5">
                      <div class="input-group mb-3">
                        ...
                        <div style="margin-left: 5px;">
                            <a href="<?= base_url; ?>/app/upload/Format Upload RO.xlsx" class="btn float-right btn btn-outline-success"><i class = "fa fa-download"></i></a>
                        </div>
                      </div>
                    </div>
              ...
              <div class="col-sm-6" style="display: flex; justify-content: flex-end">
                <form action="<?= base_url; ?>/RO" enctype="multipart/form-data" method="POST" role="form">
                  <?php
                      if(isset($data))
                      {
                          $month = $data['by_month'];
                  ...
                  <div class="row">
                    <div class="input-group mb-3">
                      ...
                      <div style="margin-left : 5px;">
                          ...
                          <a class="btn btn-outline-secondary" href="<?= base_url; ?>/RO">Reset</a>
                      </div>
                    </div>
                  </div>
                </form>
              ...
              <table id="target_so" class="table table-bordered nowrap" style="font-size:80%; border: 1px solid black; width: 100%;">
                <thead>
                    <tr>
                        ...
                        <th class="text-center" style="width: 20px; vertical-align: middle;">Outlet Type</th>
                        <th class="text-center" style="width: 225px; vertical-align: middle;">Description</th>
                        <th class="text-center" style="width: 15px">RO</th>
                    </tr>
                </thead>
                <tbody>
                    <?php $no=1; ?>
                    <?php foreach ($data['RO'] as $row) :?>
                    <tr>
    ...
    excel_file.addEventListener('change', (event) => {
        ...
        reader.onload = function(event){
            ...
            if(sheet_data.length > 1)
            {
              ...
              if(sheet_data[1][1].toUpperCase() != "TAHUN" || sheet_data[1][2].toUpperCase() != "BULAN" || sheet_data[1][3].toUpperCase() != "PRINCIPAL" || sheet_data[1][4].toUpperCase() != "AREA" || sheet_data[1][5].toUpperCase() != "OUTLET_TYPE" || sheet_data[1][6].toUpperCase() != "DESCRIPTION" || sheet_data[1][7].toUpperCase() != "RO")
              {
              ...
              {
                json.push({'NO': sheet_data[row][0], 'TAHUN': sheet_data[row][1], 'BULAN': sheet_data[row][2], 'PRINCIPAL': sheet_data[row][3], 'AREA': sheet_data[row][4], 'OUTLET_TYPE': sheet_data[row][5], 'DESCRIPTION': sheet_data[row][6], 'RO': sheet_data[row][7]});
              }
            ...
            if (result.value) {
              $.ajax({
                ...
                success:function(response){
                  Swal.fire({
                      title: "Data RO telah tersimpan.",
                      text: response,
                      type: "success"
                  }).then(function() {
                      window.location = "<?= base_url; ?>/RO";
                  });
                },
