                ...
                <div class="row">
                  <div class="input-group mb-3">
                    ...
                    <div style="margin-left : 5px;">
                        ...
                        <a class="btn btn-outline-secondary" href="<?= base_url; ?>/SellingIn">Reset</a>
                    </div>
                  </div>
                </div>
              </form>
    ...
    excel_file.addEventListener('change', (event) => {
        ...
        reader.onload = function(event){
            ...
            if(sheet_data.length > 1)
            {
              ...
              if(sheet_data[0][0].toUpperCase() != "TANGGAL" || sheet_data[0][1].toUpperCase() != "INVOICE" || sheet_data[0][2].toUpperCase() != "PRINCIPAL" || sheet_data[0][3].toUpperCase() != "CUST_CODE" || sheet_data[0][4].toUpperCase() != "CUST_NAME" || sheet_data[0][5].toUpperCase() != "ITEM_CODE" || sheet_data[0][6].toUpperCase() != "ITEM_NAME" || sheet_data[0][7].toUpperCase() != "QTY" || sheet_data[0][8].toUpperCase() != "SALE_PRICE" || sheet_data[0][9].toUpperCase() != "TOTAL_DISCOUNT" || sheet_data[0][10].toUpperCase() != "VALUE_EXC" || sheet_data[0][11].toUpperCase() != "VALUE_INC")
              {
        ...
        else
        {
          Swal.fire({
            ...
            if (result.value) {
              $.ajax({
                type: 'POST',
                url:  '<?= base_url; ?>/SellingIn/importExcel2',
                data: {json:json},
                beforeSend: function() {
                  Swal.fire({
                    title: 'Uploading...',
                ...
                success:function(response){
                  Swal.fire({
                      title: "Data Selling In telah tersimpan.",
                      text: response,
                      type: "success"
                  }).then(function() {
                      window.location = "<?= base_url; ?>/SellingIn";
                  });
                },
