  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Report Selling Out - Growth SKU Existing</h1> 
    ...
    <section class="content">
        ...
        <div class="card">
            <div class="card-body"> 
                <form action="<?= base_url; ?>/Report/Sellingout_Growth_OT_Exist" method="post">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="input-group mb-3">
                                ...
                                ?>
                                    ...
                                    <div style="margin-left : 5px; margin-bottom: 5px;">
                                        ...
                                        <a class="btn btn-outline-secondary" href="<?= base_url; ?>/Report/Sellingout_Growth_OT_Exist">Reset</a>
                                    </div>
                                    <div style="margin-left : 5px; margin-bottom: 5px;">
                                        <button class="btn float-right btn btn-outline-success" type="submit" formaction="<?= base_url; ?>/Report/export_sellingout_growth_sku_exist"><i class = "fa fa-download"> Excel</i></button>
                                    </div>
                            </div>
                            ...
                            <div class="table-responsive-sm text-small">
                                <table id="sale_out_growth_exist" class="table table-bordered table-sm" align="left" style="font-size:85%; border: 1px solid black;table-layout:fixed;">
                                    <thead class="table-warning">
                                        <tr>
                                            <th rowspan="2" class="text-center" style="width: 20px; vertical-align: middle;">#</th>
                                            <th rowspan="2" class="text-center" style="width: 110px;vertical-align: middle;">Outlet Type</th>
                                            <th rowspan="2" class="text-center" style="width: 90px; vertical-align: middle;">BIG Code</th>
                                            <th rowspan="2" class="text-center" style="width: 350px;vertical-align: middle;">Outlet Name</th>
                                            <th rowspan="2" class="text-center" style="width: 100px;vertical-align: middle;">Area</th>
                                            <th rowspan="2" class="text-center" style="width: 70px;vertical-align: middle;">Item Code</th>
                                            <th rowspan="2" class="text-center" style="width: 350px;vertical-align: middle;">SKU</th>
                                            <th colspan="2" class="text-center" style="vertical-align: middle;">Value</th>
                                        </tr>
                                        <tr>
                                    ...
                                    <tbody>
                                        ...
                                        <?php foreach ($data['sellingout_OT_exist'] as $row) :?>
