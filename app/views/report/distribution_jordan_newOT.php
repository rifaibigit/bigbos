  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Distribution Progress - JORDAN (New Outlet)</h1> 
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-body"> 
            <form action="<?= base_url; ?>/Report/distribution_jordan_newOT" method="post">
                <div class="row">
                    <div class="col-md-12">
                      <div class="input-group mb-3">
                        ...
                        ?>
                          <div>
                            <select class="mdb-select md-form form-control" title="By Island" name="by_island" id="dt_island" style="margin-left : 10px;width : 125px;">
                              <!-- <?php
                          ...
                          <div style="margin-left : 5px;">
                            ...
                            <a class="btn btn-outline-secondary" href="<?= base_url; ?>/Report/distribution_jordan_newOT">Reset</a>
                          </div>
                          <div style="margin-left : 5px;">
                            <button class="btn float-right btn btn-outline-success" type="submit" formaction="<?= base_url; ?>/Report/export_distribution_jordan_newOT"><i class = "fa fa-download"> Excel</i></button>
                          </div>
                      </div>
                        ...
                        <table id="distr" class="table table-bordered table-sm" align="left" style="font-size:85%; border: 1px solid black;table-layout: fixed;">
                          <thead class="table-warning">
                            ...
                            <tr>
                              ...
                              <th rowspan="3" class="text-center" style="width: 20px; vertical-align: middle;">RO</th>
                          ...
                          <?php $channel=''; ?>
                              ...
                              <?php foreach ($data['distr_jordan'] as $row) :?>
                                ...
                                <tr>
                                    ...
                                    <?php $a++; ?>
                                    <?php endforeach; ?> 
                                    <td class="text-right"><?= number_format($row['dtotal'], 0);?></td>
