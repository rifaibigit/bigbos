  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Report Selling Out - Summary (Value)</h1> 
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
    ...
    <section class="content">
      ...
      <div class="card">
        ...
        <div class="card-body"> 
            <form action="<?= base_url; ?>/Report/sellingout_summary_val" method="post">
                <div class="row">
                    <div class="col-md-12">
                      <div class="input-group mb-3">
                        ...
                        ?>
                          ...
                          <a class="btn btn-outline-secondary" href="<?= base_url; ?>/Report/sellingout_summary_val">Reset</a>
                      </div>
                      <div>
                        <a class="btn btn-outline-secondary" href="<?= base_url; ?>/Report/sellingout_summary_qty"><i class = "fas fa-chart-line"> Qty</i></a>
                            ...
                            <tbody>
                              ...
                              <?php foreach ($data['sellingout'] as $row) :?>
                                ...
                                <?php
                                      ...
                                      if ($outlet_category != $row['outlet_category'] and $outlet_category != '' and $outlet_category != $channel )
                                      {
                                          ...
                                          echo '<tr class="table text-center" style="font-weight:bold;">';
                                              ...
                                              echo '<td class="text-right">' .number_format($sub_qty_oc/($qty ?: 1)*100,1). ' %</td>';
                                              echo '<td class="text-right">' .number_format($sub_qty_oc/($qty ?: 1)*100,1). ' %</td>';
                                          echo '</tr>';
                                          $sub_qty_oc = 0;
                                      }
                                      ...
                                      if ($channel != $row['channel'] and $channel != '')
                                      {
                                        ...
                                        if($channel === 'MTKA' and $outlet_category === 'MTKA')
                                          ...
                                          echo '<tr class="table text-center" style="font-weight:bold;">';
                                              ...
                                              echo '<td class="text-right">' .number_format($sub_qty_channel/($qty ?: 1)*100,1). ' %</td>';
                                              echo '<td class="text-right">' .number_format($sub_qty_channel/($qty ?: 1)*100,1). ' %</td>';
                                          echo '</tr>';
                                          ...
                                          if($channel === 'MTI' and $outlet_category === 'MTI')
                                          {
                                            ...
                                            echo '<tr class="table text-center" style="font-weight:bold;">';
                                                ...
                                                echo '<td class="text-right">' .number_format($sub_qty_MT/($qty ?: 1)*100,1). ' %</td>';
                                                echo '<td class="text-right">' .number_format($sub_qty_MT/($qty ?: 1)*100,1). ' %</td>';
                                            echo '</tr>';
                                            $sub_qty_channel = 0;
                                            $sub_qty_oc = 0;
                                ...
                                <tr>
                                  ...
                                  ?>
                                  <!-- <td><a href="<?= base_url; ?>/Report/getSellingoutOT/<?= $row['id']; ?>" target="_blank"><?= $row['desc_type'];?></a></td> -->
                                  ...
                                  <td class="text-right"><?= number_format($row['val']/($qty_ar[$ii-1] ?: 1)*100,1);?> %</td>
                                  <td class="text-right"><?= number_format($row['val']/($qty ?: 1)*100,1);?> %</td>
                                </tr>

                              <?php $sub_qty_channel += $row['val'];?>
                              <?php $sub_qty_oc += $row['val'];?>
                              ...
                              <tr class="table text-center" style="font-weight:bold;">
                                  ...
                                  <td class="text-right"><?= number_format($sub_qty_oc/($qty ?: 1)*100,1);?> %</td>
                                  <td class="text-right"><?= number_format($sub_qty_oc/($qty ?: 1)*100,1);?> %</td>
                              </tr>
                              ...
                              <tr class="table text-center" style="font-weight:bold;">
                                  ...
                                  <td class="text-right"><?= number_format($sub_qty_channel/($qty ?: 1)*100,1);?> %</td>
                                  <td class="text-right"><?= number_format($sub_qty_channel/($qty ?: 1)*100,1);?> %</td>
                              </tr>
                              ...
                              <tr>
                                ...
                                <td style="font-weight:bold" class="text-right"><?= number_format($grand_total/($qty ?: 1)*100,1);?> %</td>
                                <td style="font-weight:bold" class="text-right"><?= number_format($grand_total/($qty ?: 1)*100,1);?> %</td>
                              </tr>
                        ...
                        <!-- <div class="row"> -->
                          <div class="clearfix" style="margin-left: 50px;">
                            ...
                            <!-- <div style="width: 350px;height: 350px;margin-top: 10px;margin-left: 30px;">
...
var myChart = new Chart(ctx, {
    ...
    data: {
        ...
        datasets: [{
                label: '# OL',
                data: [<?php echo round($qty_ar[0],2) . ', ' . round($qty_ar[1],2) . ', ' . round($qty_ar[2],2) . ', ' . round($qty_ar[3],2); ?>],
