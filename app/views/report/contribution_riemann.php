  ...
  <div class="content-wrapper">
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
            ...
            ?>
            <h1>Contribution Summary - RIEMANN (<?php echo $monthName1. ' To ' .$monthName2;?>)</h1> 
    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-body"> 
            <form action="<?= base_url; ?>/Report/contribution_riemann" method="post">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="table-responsive-sm text-small">
                          ...
                          <thead class="table-warning">
                            ...
                            <?php $channel=''; ?>
                                ...
                                <!-- Online -->
                                <?php foreach ($data['cont_riemann'] as $row) :?>
