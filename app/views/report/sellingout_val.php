  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-body"> 
            <form action="<?= base_url; ?>/Report/sellingout_val" method="post">
                <div class="row">
                    <div class="col-md-12">
                      <div class="input-group mb-3">
                        ...
                        ?>
                          ...
                          <div style="margin-left : 10px;">
                            ...
                            <a class="btn btn-outline-secondary" href="<?= base_url; ?>/Report/sellingout_val">Reset</a>
                          </div>
                          <div style="margin-left : 10px;">
                            <button class="btn btn btn-outline-success" type="submit" formaction="<?= base_url; ?>/Report/export_sellingout_val"><i class = "fa fa-download"> Excel</i></button>
