  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-body"> 
            <form action="<?= base_url; ?>/Report/activeoutlet_toastbox" method="post">
                <div class="row">
                    <div class="col-md-12">
                      <div class="input-group mb-3">
                        ...
                        ?>
                          ...
                          <div style="margin-left : 5px;">
                            ...
                            <a class="btn btn-outline-secondary" href="<?= base_url; ?>/Report/activeoutlet_toastbox">Reset</a>
                          </div>
                          <div style="margin-left : 5px;">
                            <button class="btn float-right btn btn-outline-success" type="submit" formaction="<?= base_url; ?>/Report/export_activeoutlet_toastbox"><i class = "fa fa-download"> Excel</i></button>
                          </div>
                      </div>

                        <!-- <div id="hasil_sale_out"></div> -->
                        <div class="table-responsive-sm text-small">
                          <table id="ao" class="table table-bordered table-sm" align="left" style="font-size:85%; border: 1px solid black;table-layout: fixed;">
                            <thead class="table-warning">
                              ...
                              <tr>
                                ...
                                <th rowspan="3" class="text-center" style="width: 170px; vertical-align: middle; white-space:nowrap;">TYPE OF OUTLET</th>
                                ...
                                <th colspan="<?= $row['count_name']*2;?>" class="text-center" style="white-space: nowrap;"><?= $row['item_group'];?></th>
                                <?php endforeach ?>
                              ...
                              <tr style="line-height: 10px; vertical-align: middle;">
                                ...
                                ?> 
                                <th class="text-center" style="width: 40px; vertical-align: middle; background-color: #FF6D6D;">AO</th>
                            ...
                            <?php $channel=''; ?>
                                ...
                                <?php foreach ($data['distr_toastbox'] as $row) :?>
                                <?php
                                ...
                                <tr>
                                    ...
                                    <?php $a=1; ?>
                                      ...
                                      <?php $a++; ?>
                                      <?php endforeach; ?> 
                                      <td class="text-right"><b><a href="<?= base_url; ?>/Report/ActiveOutlet_OT2/<?= implode(",", $data1); ?>" target="_blank"><?= number_format($row['dtotal'], 0);?></a></b></td>
