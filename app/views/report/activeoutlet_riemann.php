  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-body"> 
            <form action="<?= base_url; ?>/Report/activeoutlet_riemann" method="post">
                <div class="row">
                    <div class="col-md-12">
                      <div class="input-group mb-3">
                        ...
                        ?>
                          ...
                          <div style="margin-left : 5px;">
                            ...
                            <a class="btn btn-outline-secondary" href="<?= base_url; ?>/Report/activeoutlet_riemann">Reset</a>
                          </div>
                          <div style="margin-left : 5px;">
                            <button class="btn float-right btn btn-outline-success" type="submit" formaction="<?= base_url; ?>/Report/export_activeoutlet_riemann"><i class = "fa fa-download"> Excel</i></button>
                          </div>
                      </div>
                        ...
                        <div class="table-responsive-sm text-small">
                          <table id="ao" class="table table-bordered table-sm" align="left" style="font-size:85%; border: 1px solid black;table-layout: fixed;">
                            ...
                            <?php $channel=''; ?>
                                ...
                                <?php foreach ($data['distr_riemann'] as $row) :?>
                                <?php
