  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Direct Active Outlet - Detail</h1>  
                </div>
            </div>
        </div><!-- /.container-fluid -->
    </section>
    ...
    <section class="content">
        ...
        <div class="card">
            <div class="card-body"> 
                <form action="<?= base_url; ?>/Report/AO_Direct_OT" id="convert_form" method="post">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="input-group mb-3">
                                ...
                                ?>
                                    ...
                                    <div style="margin-left : 5px;">
                                        ...
                                        <a class="btn btn-outline-secondary" href="<?= base_url; ?>/Report/AO_Direct_OT">Reset</a>
                                    </div>
                                    <div style="margin-left : 5px;">
                                        <button class="btn float-right btn btn-outline-success" type="submit" formaction="<?= base_url; ?>/Report/export_AO_Direct_OT"><i class = "fa fa-download"> Excel</i></button>
                                    </div>
                            ...
                            <div class="table-responsive-sm text-small" id="employee_table">
                                <table id="direct_in_ot" class="table table-bordered table-sm nowrap" align="left" style="font-size:85%; border: 1px solid black;table-layout:fixed;">
                                    <thead class="table-warning">
                                        <tr>
                                            <th rowspan="3" class="text-center" style="width: 5px; vertical-align: middle;">#</th>
                                            <th rowspan="3" class="text-center" style="width: 50px;vertical-align: middle;">Cust Code</th>
                                            <th rowspan="3" class="text-center" style="width: 350px; vertical-align: middle;">Outlet Name</th>
                                        ...
                                        <tr>
                                            <th class="text-center" style="width: 50px; vertical-align: middle;">Jan</th>
                                            <th class="text-center" style="width: 50px; vertical-align: middle;">Feb</th>
                                            <th class="text-center" style="width: 50px; vertical-align: middle;">Mar</th>
                                            <th class="text-center" style="width: 50px; vertical-align: middle;">Apr</th>
                                            <th class="text-center" style="width: 50px; vertical-align: middle;">May</th>
                                            <th class="text-center" style="width: 50px; vertical-align: middle;">Jun</th>
                                            <th class="text-center" style="width: 50px; vertical-align: middle;">Jul</th>
                                            <th class="text-center" style="width: 50px; vertical-align: middle;">Aug</th>
                                            <th class="text-center" style="width: 50px; vertical-align: middle;">Sep</th>
                                            <th class="text-center" style="width: 50px; vertical-align: middle;">Oct</th>
                                            <th class="text-center" style="width: 50px; vertical-align: middle;">Nov</th>
                                            <th class="text-center" style="width: 50px; vertical-align: middle;">Dec</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td style="overflow: hidden;"><?= $row['cust_code'];?></td>
                                            <td><?= $row['cust_name'];?></td>
