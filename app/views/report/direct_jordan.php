  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Direct Distribution - JORDAN</h1> 
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-body"> 
            <form action="<?= base_url; ?>/Report/direct_jordan" method="post">
                <div class="row">
                    <div class="col-md-12">
                      <div class="input-group mb-3">
                        ...
                        ?>
                          ...
                          <div style="margin-left : 5px;">
                            ...
                            <a class="btn btn-outline-secondary" href="<?= base_url; ?>/Report/direct_jordan">Reset</a>
                          </div>
                          <div style="margin-left : 5px;">
                            <button class="btn float-right btn btn-outline-success" type="submit" formaction="<?= base_url; ?>/Report/export_direct_jordan"><i class = "fa fa-download"> Excel</i></button>
                          </div>
                      </div>
                          ...
                          <?php $channel=''; ?>
                              ...
                              <?php foreach ($data['distr_jordan'] as $row) :?>
                                ...
                                <tr>
                                    ...
                                    ?> 
                                    <td class="text-right"><b><a href="<?= base_url; ?>/Report/Direct_OT2/<?= implode(",", $data1); ?>" target="_blank"><?= number_format($row['dtotal'], 0);?></a></b></td>
