  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Report Selling Out - Quantity</h1> 
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-body"> 
            <form action="<?= base_url; ?>/Report/sellingout_qty" method="post">
                <div class="row">
                    <div class="col-md-12">
                      <div class="input-group mb-3">
                        ...
                        ?>
                          ...
                          <div style="margin-left : 10px;">
                            <button class="btn btn btn-outline-success" type="submit" formaction="<?= base_url; ?>/Report/export_sellingout_qty"><i class = "fa fa-download"> Excel</i></button>
...
var myChart = new Chart(ctx, {
    ...
    options: {
        ...
        title: {
            display: true,
            position: "top",
            text: "Chart Selling Out - Quantity",
            fontSize: 16,
            fontColor: "#111"
        },
        legend: {
