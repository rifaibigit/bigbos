  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Report Selling In - Summary (Quantity)</h1> 
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
    ...
    <section class="content">
      ...
      <div class="card">
        ...
        <div class="card-body"> 
            <form action="<?= base_url; ?>/report/sellingin_summary_qty" method="post">
                <div class="row">
                    <div class="col-md-12">
                      <div class="input-group mb-3">
                        ...
                        ?>
                          ...
                          <a class="btn btn-outline-secondary" href="<?= base_url; ?>/report/sellingin_summary_qty">Reset</a>
                      </div>
                      <div>
                        <a class="btn btn-info" href="#"><i class = "fas fa-chart-line"> Qty</i></a>
                        <a class="btn btn-outline-secondary" href="<?= base_url; ?>/report/sellingin_summary_val"><i class = "fas fa-chart-line"> Value</i></a>
                      </div>
                            ...
                            <tbody>
                              ...
                              <?php foreach ($data['sellingin'] as $row) :?>
                                ...
                                <?php
                                        ...
                                        if ($outlet_category != $row['outlet_category'] and $outlet_category != '' and $outlet_category != $channel )
                                        {
                                            ...
                                            echo '<tr class="table text-center" style="font-weight:bold;">';
                                                ...
                                                echo '<td class="text-right">' .number_format($sub_qty_oc/($qty_total ?: 1)*100,1). ' %</td>';
                                                echo '<td class="text-right">' .number_format($sub_qty_oc/($qty_total ?: 1)*100,1). ' %</td>';
                                            echo '</tr>';
                                            $sub_qty_oc = 0;
                                        }
                                        ...
                                        if ($channel != $row['channel'] and $channel != '')
                                        {
                                          ...
                                          if($channel === 'MTKA' and $outlet_category === 'MTKA')
                                            {
                                              $sub_qty_mtka = $sub_qty_channel;
                                            }

                                            if($channel === 'MTI' and $outlet_category === 'MTI')
                                            {
                                              $sub_qty_mti = $sub_qty_channel;
                                            }
                                            ...
                                            echo '<tr class="table text-center" style="font-weight:bold;">';
                                                ...
                                                echo '<td class="text-right">' .number_format($sub_qty_channel/($qty_total ?: 1)*100,1). ' %</td>';
                                                echo '<td class="text-right">' .number_format($sub_qty_channel/($qty_total ?: 1)*100,1). ' %</td>';
                                            echo '</tr>';
                                            ...
                                            if($channel === 'MTI' and $outlet_category === 'MTI')
                                            {
                                              $sub_qty_MT = $sub_qty_mtka + $sub_qty_mti;
                                              echo '<tr class="table text-center" style="font-weight:bold;">';
                                                  echo '<td></td>';
                                                  echo '<td>TOTAL MT</td>';
                                                  echo '<td></td>';
                                                  echo '<td></td>';
                                                  echo '<td class="text-right">' .number_format($sub_qty_MT, 0). '</td>';
                                                  echo '<td class="text-right">' .number_format($sub_qty_MT/($qty_total ?: 1)*100,1). ' %</td>';
                                                  echo '<td class="text-right">' .number_format($sub_qty_MT/($qty_total ?: 1)*100,1). ' %</td>';
                                              echo '</tr>';
                                              $sub_qty_channel = 0;
                                              $sub_qty_oc = 0;
                                ...
                                <tr>
                                  ...
                                  <!-- <td><a href="<?= base_url; ?>/report/getSellinginOT?by_outlet_type=$row['outlet_type']" target="_blank"><?= $row['desc_type'];?></a></td> -->
                                  ...
                                  <td class="text-right"><?= number_format($row['qty']/($qty_ar[$ii-1] ?: 1)*100,1);?> %</td>
                                  <td class="text-right"><?= number_format($row['qty']/($qty ?: 1)*100,1);?> %</td>
                                </tr>
                              ...
                              <tr class="table text-center" style="font-weight:bold;">
                                  ...
                                  <td></td>
                                  <td class="text-right"><?= number_format($sub_qty_oc, 0) ;?></td>
                                  <td class="text-right"><?= number_format($sub_qty_oc/($qty_total ?: 1)*100,1);?> %</td>
                                  <td class="text-right"><?= number_format($sub_qty_oc/($qty_total ?: 1)*100,1);?> %</td>
                              </tr>
                              ...
                              <tr class="table text-center" style="font-weight:bold;">
                                  ...
                                  <td></td>
                                  <td></td>
                                  <td class="text-right"><?= number_format($sub_qty_channel, 0) ;?></td>
                                  <td class="text-right"><?= number_format($sub_qty_channel/($qty_total ?: 1)*100,1);?> %</td>
                                  <td class="text-right"><?= number_format($sub_qty_channel/($qty_total ?: 1)*100,1);?> %</td>
                              </tr>
                              ...
                              <tr>
                                ...
                                <td style="font-weight:bold" class="text-right"><?= number_format(($grand_total)/($qty_total ?: 1)*100,1);?> %</td>
                                <td style="font-weight:bold" class="text-right"><?= number_format(($grand_total)/($qty_total ?: 1)*100,1);?> %</td>
                              </tr>
                              ...
                              <tr>
                                ...
                                <td><?= $outlet_dist ;?></td>
                                <td style="font-weight:bold" class="text-right"><?= number_format($qty_dist, 0);?></td>
                                <td style="font-weight:bold" class="text-right"><?= number_format($qty_dist/($qty_total ?: 1)*100,1);?> %</td>
                                <td style="font-weight:bold" class="text-right"><?= number_format($qty_dist/($qty_total ?: 1)*100,1);?> %</td>
                              </tr>
                              ...
                              <tr>
                                ...
                                <td></td>
                                <td></td>
                                <td style="font-weight:bold" class="text-right"><?= number_format($grand_total + $qty_dist, 0);?></td>
                                <td style="font-weight:bold" class="text-right"><?= number_format(($grand_total + $qty_dist)/($qty_total ?: 1)*100,1);?> %</td>
                                <td style="font-weight:bold" class="text-right"><?= number_format(($grand_total + $qty_dist)/($qty_total ?: 1)*100,1);?> %</td>
                              </tr>
                        ...
                        <!-- <div class="row"> -->
                          <div class="clearfix" style="margin-left: 10px; ">
                            ...
                            <div class="col" style="width: 400px;height: 400px; margin-top: 0px;margin-left: 10px;">
...
var myChart = new Chart(ctx, {
    type: 'pie',
    data: {
        // labels: [<?php echo $channel_ar[0] . ', ' . $channel_ar[1] . ', ' . $channel_ar[2] . ', ' . $channel_ar[3] . ', ' . $qty_dist; ?>],
        labels: ['ONLINE', 'MTKA', 'MTI', 'GENERAL TRADE', 'DISTRIBUTOR'],
        datasets: [{
                
                data: [<?php echo $qty_ar[0] . ', ' . $qty_ar[1] . ', ' . $qty_ar[2] . ', ' . $qty_ar[3] . ', ' . $qty_dist; ?>],
                backgroundColor: [
                    'rgba(0, 15, 255, 0.5)',
                    'rgba(47, 244, 79, 0.6)',
                    'rgba(255, 248, 0, 0.6)',
