  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Report Selling Out - Summary (Quantity)</h1> 
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
    ...
    <section class="content">
      ...
      <div class="card">
        ...
        <div class="card-body"> 
            <form action="<?= base_url; ?>/Report/sellingout_summary_qty" method="post">
                <div class="row">
                    <div class="col-md-12">
                      <div class="input-group mb-3">
                        ...
                        ?>
                          ...
                          <a class="btn btn-outline-secondary" href="<?= base_url; ?>/Report/sellingout_summary_qty">Reset</a>
                      </div>
                      <div>
                        <a class="btn btn-info" href="#"><i class = "fas fa-chart-line"> Qty</i></a>
                        <a class="btn btn-outline-secondary" href="<?= base_url; ?>/Report/sellingout_summary_val"><i class = "fas fa-chart-line"> Value</i></a>
                      </div>
