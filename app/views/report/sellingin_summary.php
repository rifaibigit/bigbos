  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Report Selling In - Summary</h1> 
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
            ...
            <div class="chart tab-pane fade show active" id="revenue-chart" style="position: relative;">
                <form action="<?= base_url; ?>/Report/sellingin_summary" method="post">
                  ...
                  <div class="row" style="margin-left: 5px;margin-right: 5px;">
                    ...
                    <div>
                      <button class="btn btn-outline-primary" type="submit" style="margin-left : 5px;" onclick="openLoader()">Go!</button>
                      <a class="btn btn-outline-secondary" href="<?= base_url; ?>/Report/sellingin_summary" onclick="openLoader()">Reset</a>
                    </div>
                  </div>
                  <div class="row">
                    <section class="col-sm-8 connectedSortable">
                      <!-- <div class="card-deck" style="margin-left:5px;margin-right:5px;"> -->
                        <div class="table-responsive-sm text-small">
                          <table id="rpt_sale_in_qty" class="table table-bordered table-sm nowrap" align="left" style="font-size:85%">
                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td style="font-weight:bold" class="text-right"><?= number_format(($grand_total)/($qty_total ?: 1)*100,2);?> %</td>
                                <td style="font-weight:bold" class="text-right"><?= number_format(($grand_total)/($qty_total ?: 1)*100,2);?> %</td>
                              </tr>
            ...
            <div class="chart tab-pane fade show" id="sales-chart" style="position: relative;">
                <form action="<?= base_url; ?>/Report/sellingin_summary" method="post">
                  ...
                  <div class="row">
                    <section class="col-sm-8 connectedSortable">
                      <div class="table-responsive-sm text-small">  
                        <table id="rpt_sale_in_val" class="table table-bordered table-sm nowrap" align="left" style="font-size:85%">
                          <thead class="thead-light">
                              <tr>
                                <th rowspan="2" class="text-center" style="vertical-align: middle;">#</th>
                                <th rowspan="2" class="text-center" style="vertical-align: middle;">Channel</th>
                          ...
                          <?php 
                              ...
                              <?php
                                      ...
                                      if ($outlet_category != $row['outlet_category'] and $outlet_category != '' and $outlet_category != $channel )
                                      {
                                          ...
                                          echo '<tr class="table text-center" style="font-weight:bold;">';
                                              ...
                                              echo '<td class="text-right">' .number_format($sub_val_oc/($val_total ?: 1)*100,2). ' %</td>';
                                              echo '<td class="text-right">' .number_format($sub_val_oc/($val_total ?: 1)*100,2). ' %</td>';
                                          echo '</tr>';
                                          $sub_val_oc = 0;
                                      }
                                      ...
                                      if ($channel != $row['channel'] and $channel != '')
                                      {
                                          ...
                                          echo '<tr class="table text-center" style="font-weight:bold;">';
                                              ...
                                              echo '<td class="text-right">' .number_format($sub_val_channel/($val_total ?: 1)*100,2). ' %</td>';
                                              echo '<td class="text-right">' .number_format($sub_val_channel/($val_total ?: 1)*100,2). ' %</td>';
                                          echo '</tr>';
                            ...
                            <!-- <tr class="table text-center" style="font-weight:bold;">
                              ...
                              <td class="text-right"><?= number_format($sub_val_oc/($val_total ?: 1)*100,2);?> %</td>
                              <td class="text-right"><?= number_format($sub_val_oc/($val_total ?: 1)*100,2);?> %</td>
                            </tr> -->
                            ...
                            <tr>
                              ...
                              <td style="font-weight:bold" class="text-right"><?= number_format(($grand_total + $val_dist)/($val_total ?: 1)*100,2);?> %</td>
                              <td style="font-weight:bold" class="text-right"><?= number_format(($grand_total + $val_dist)/($val_total ?: 1)*100,2);?> %</td>
                            </tr>
...
<script>  
  ...
  var channel_arr = new Array(<?php echo "'".implode("','", $channel_ar)."'" ;?>);
  var qty_arr = new Array(<?php echo "'".implode("','", $qty_ar)."'" ;?>);
...
<script>  
  ...
  var channel_arr = new Array(<?php echo "'".implode("','", $channel_ar)."'" ;?>);
  var val_arr = new Array(<?php echo "'".implode("','", $val_ar)."'" ;?>);
  /* ctx.height = 200;
  ctx.width = 200; */
  var myChart = new Chart(ctx, {
      type: 'pie',
