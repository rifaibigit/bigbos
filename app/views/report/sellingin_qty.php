  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Report Selling In - Quantity</h1> 
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-body"> 
            <form action="<?= base_url; ?>/Report/sellingin_qty" method="post">
                <div class="row">
                    <div class="col-md-12">
                      <div class="input-group mb-3">
                        ...
                        ?>
                          ...
                          <div style="margin-left : 5px;">
                            ...
                            <a class="btn btn-outline-secondary" href="<?= base_url; ?>/Report/sellingin_qty">Reset</a>
                            <button class="btn btn-outline-success" type="submit" style="margin-left : 20px;" formaction="<?= base_url; ?>/Report/export_sellingin_qty"><i class = "fa fa-download"> Excel</i></button>
                        ...
                        <div class="table-responsive-sm text-small">
                          <table id="sale_in_qty" class="table table-bordered table-sm order-column nowrap" align="left" style="font-size:85%; border: 1px solid black;">
                          ...
                          <?php //$json = json_encode(array('data' => $data['chart'])); ?>

                          <?php //print_r($data['chart']) ;?>
                          <?php //print_r($json) ;?>
...
var myChart = new Chart(ctx, {
    ...
    data: {
        ...
        datasets: [{
          label: '#  <?php echo $item_group[0]; ?>',
                data: ['<?php echo $data['chart'][0]['qty_jan']; ?>', '<?php echo $data['chart'][0]['qty_feb']; ?>', '<?php echo $data['chart'][0]['qty_mar']; ?>', '<?php echo $data['chart'][0]['qty_apr']; ?>', '<?php echo $data['chart'][0]['qty_mei']; ?>', '<?php echo $data['chart'][0]['qty_jun']; ?>', '<?php echo $data['chart'][0]['qty_jul']; ?>', '<?php echo $data['chart'][0]['qty_agu']; ?>', '<?php echo $data['chart'][0]['qty_sep']; ?>', '<?php echo $data['chart'][0]['qty_okt']; ?>', '<?php echo $data['chart'][0]['qty_nop']; ?>', '<?php echo $data['chart'][0]['qty_des']; ?>'],
                backgroundColor: [
                    'rgba(0, 0, 0, 0)',
                    'rgba(0, 0, 0, 0)',
                    'rgba(0, 0, 0, 0)',
            ...
            },
            {
                ...
                data: ['<?php echo $data['chart'][1]['qty_jan']; ?>', '<?php echo $data['chart'][1]['qty_feb']; ?>', '<?php echo $data['chart'][1]['qty_mar']; ?>', '<?php echo $data['chart'][1]['qty_apr']; ?>', '<?php echo $data['chart'][1]['qty_mei']; ?>', '<?php echo $data['chart'][1]['qty_jun']; ?>', '<?php echo $data['chart'][1]['qty_jul']; ?>', '<?php echo $data['chart'][1]['qty_agu']; ?>', '<?php echo $data['chart'][1]['qty_sep']; ?>', '<?php echo $data['chart'][1]['qty_okt']; ?>', '<?php echo $data['chart'][1]['qty_nop']; ?>', '<?php echo $data['chart'][1]['qty_des']; ?>'],
                backgroundColor: [
                    'rgba(0, 0, 0, 0)',
                    'rgba(0, 0, 0, 0)',
                    'rgba(0, 0, 0, 0)',
            ...
            },
            {
                ...
                data: ['<?php echo $data['chart'][2]['qty_jan']; ?>', '<?php echo $data['chart'][2]['qty_feb']; ?>', '<?php echo $data['chart'][2]['qty_mar']; ?>', '<?php echo $data['chart'][2]['qty_apr']; ?>', '<?php echo $data['chart'][2]['qty_mei']; ?>', '<?php echo $data['chart'][2]['qty_jun']; ?>', '<?php echo $data['chart'][2]['qty_jul']; ?>', '<?php echo $data['chart'][2]['qty_agu']; ?>', '<?php echo $data['chart'][2]['qty_sep']; ?>', '<?php echo $data['chart'][2]['qty_okt']; ?>', '<?php echo $data['chart'][2]['qty_nop']; ?>', '<?php echo $data['chart'][2]['qty_des']; ?>'],
                backgroundColor: [
                    'rgba(0, 0, 0, 0)',
                    'rgba(0, 0, 0, 0)',
                    'rgba(0, 0, 0, 0)',
            ...
            },
            {
                ...
                data: ['<?php echo $data['chart'][3]['qty_jan']; ?>', '<?php echo $data['chart'][3]['qty_feb']; ?>', '<?php echo $data['chart'][3]['qty_mar']; ?>', '<?php echo $data['chart'][3]['qty_apr']; ?>', '<?php echo $data['chart'][3]['qty_mei']; ?>', '<?php echo $data['chart'][3]['qty_jun']; ?>', '<?php echo $data['chart'][3]['qty_jul']; ?>', '<?php echo $data['chart'][3]['qty_agu']; ?>', '<?php echo $data['chart'][3]['qty_sep']; ?>', '<?php echo $data['chart'][3]['qty_okt']; ?>', '<?php echo $data['chart'][3]['qty_nop']; ?>', '<?php echo $data['chart'][3]['qty_des']; ?>'],
                backgroundColor: [
                    'rgba(0, 0, 0, 0)',
                    'rgba(0, 0, 0, 0)',
                    'rgba(0, 0, 0, 0)',
            ...
            },
            {
                ...
                data: ['<?php echo $data['chart'][4]['qty_jan']; ?>', '<?php echo $data['chart'][4]['qty_feb']; ?>', '<?php echo $data['chart'][4]['qty_mar']; ?>', '<?php echo $data['chart'][4]['qty_apr']; ?>', '<?php echo $data['chart'][4]['qty_mei']; ?>', '<?php echo $data['chart'][4]['qty_jun']; ?>', '<?php echo $data['chart'][4]['qty_jul']; ?>', '<?php echo $data['chart'][4]['qty_agu']; ?>', '<?php echo $data['chart'][4]['qty_sep']; ?>', '<?php echo $data['chart'][4]['qty_okt']; ?>', '<?php echo $data['chart'][4]['qty_nop']; ?>', '<?php echo $data['chart'][4]['qty_des']; ?>'],
                backgroundColor: [
                    'rgba(0, 0, 0, 0)',
                    'rgba(0, 0, 0, 0)',
                    'rgba(0, 0, 0, 0)',
            ...
            },
            {
                ...
                data: ['<?php echo $data['chart'][5]['qty_jan']; ?>', '<?php echo $data['chart'][5]['qty_feb']; ?>', '<?php echo $data['chart'][5]['qty_mar']; ?>', '<?php echo $data['chart'][5]['qty_apr']; ?>', '<?php echo $data['chart'][5]['qty_mei']; ?>', '<?php echo $data['chart'][5]['qty_jun']; ?>', '<?php echo $data['chart'][5]['qty_jul']; ?>', '<?php echo $data['chart'][5]['qty_agu']; ?>', '<?php echo $data['chart'][5]['qty_sep']; ?>', '<?php echo $data['chart'][5]['qty_okt']; ?>', '<?php echo $data['chart'][5]['qty_nop']; ?>', '<?php echo $data['chart'][5]['qty_des']; ?>'],
                backgroundColor: [
                    'rgba(0, 0, 0, 0)',
                    'rgba(0, 0, 0, 0)',
                    'rgba(0, 0, 0, 0)',
            ...
            },
            {
                ...
                data: ['<?php echo $data['chart'][6]['qty_jan']; ?>', '<?php echo $data['chart'][6]['qty_feb']; ?>', '<?php echo $data['chart'][6]['qty_mar']; ?>', '<?php echo $data['chart'][6]['qty_apr']; ?>', '<?php echo $data['chart'][6]['qty_mei']; ?>', '<?php echo $data['chart'][6]['qty_jun']; ?>', '<?php echo $data['chart'][6]['qty_jul']; ?>', '<?php echo $data['chart'][6]['qty_agu']; ?>', '<?php echo $data['chart'][6]['qty_sep']; ?>', '<?php echo $data['chart'][6]['qty_okt']; ?>', '<?php echo $data['chart'][6]['qty_nop']; ?>', '<?php echo $data['chart'][6]['qty_des']; ?>'],
                backgroundColor: [
                    'rgba(0, 0, 0, 0)',
                    'rgba(0, 0, 0, 0)',
                    'rgba(0, 0, 0, 0)',
            ...
            },
            {
                ...
                data: ['<?php echo $data['chart'][7]['qty_jan']; ?>', '<?php echo $data['chart'][7]['qty_feb']; ?>', '<?php echo $data['chart'][7]['qty_mar']; ?>', '<?php echo $data['chart'][7]['qty_apr']; ?>', '<?php echo $data['chart'][7]['qty_mei']; ?>', '<?php echo $data['chart'][7]['qty_jun']; ?>', '<?php echo $data['chart'][7]['qty_jul']; ?>', '<?php echo $data['chart'][7]['qty_agu']; ?>', '<?php echo $data['chart'][7]['qty_sep']; ?>', '<?php echo $data['chart'][7]['qty_okt']; ?>', '<?php echo $data['chart'][7]['qty_nop']; ?>', '<?php echo $data['chart'][7]['qty_des']; ?>'],
                backgroundColor: [
                    'rgba(0, 0, 0, 0)',
                    'rgba(0, 0, 0, 0)',
                    'rgba(0, 0, 0, 0)',
            ...
            },
            {
                ...
                data: ['<?php echo $data['chart'][8]['qty_jan']; ?>', '<?php echo $data['chart'][8]['qty_feb']; ?>', '<?php echo $data['chart'][8]['qty_mar']; ?>', '<?php echo $data['chart'][8]['qty_apr']; ?>', '<?php echo $data['chart'][8]['qty_mei']; ?>', '<?php echo $data['chart'][8]['qty_jun']; ?>', '<?php echo $data['chart'][8]['qty_jul']; ?>', '<?php echo $data['chart'][8]['qty_agu']; ?>', '<?php echo $data['chart'][8]['qty_sep']; ?>', '<?php echo $data['chart'][8]['qty_okt']; ?>', '<?php echo $data['chart'][8]['qty_nop']; ?>', '<?php echo $data['chart'][8]['qty_des']; ?>'],
                backgroundColor: [
                    'rgba(0, 0, 0, 0)',
                    'rgba(0, 0, 0, 0)',
                    'rgba(0, 0, 0, 0)',
            ...
            },
            {
                ...
                data: ['<?php echo $data['chart'][9]['qty_jan']; ?>', '<?php echo $data['chart'][9]['qty_feb']; ?>', '<?php echo $data['chart'][9]['qty_mar']; ?>', '<?php echo $data['chart'][9]['qty_apr']; ?>', '<?php echo $data['chart'][9]['qty_mei']; ?>', '<?php echo $data['chart'][9]['qty_jun']; ?>', '<?php echo $data['chart'][9]['qty_jul']; ?>', '<?php echo $data['chart'][9]['qty_agu']; ?>', '<?php echo $data['chart'][9]['qty_sep']; ?>', '<?php echo $data['chart'][9]['qty_okt']; ?>', '<?php echo $data['chart'][9]['qty_nop']; ?>', '<?php echo $data['chart'][9]['qty_des']; ?>'],
                backgroundColor: [
                    'rgba(0, 0, 0, 0)',
                    'rgba(0, 0, 0, 0)',
                    'rgba(0, 0, 0, 0)',
    ...
    options: {
        ...
        title: {
            display: true,
            position: "top",
            text: "Chart Selling In - Quantity",
            fontSize: 16,
            fontColor: "#111"
        },
        legend: {
