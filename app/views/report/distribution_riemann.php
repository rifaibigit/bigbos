  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Distribution Progress - RIEMANN</h1> 
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-body"> 
            <form action="<?= base_url; ?>/Report/distribution_riemann" method="post">
                <div class="row">
                    <div class="col-md-12">
                      <div class="input-group mb-3">
                        ...
                        ?>
                          ...
                          <div style="margin-left : 5px;">
                            ...
                            <a class="btn btn-outline-secondary" href="<?= base_url; ?>/Report/distribution_riemann">Reset</a>
                          </div>
                          <div style="margin-left : 5px;">
                            <button class="btn float-right btn btn-outline-success" type="submit" formaction="<?= base_url; ?>/Report/export_distribution_riemann"><i class = "fa fa-download"> Excel</i></button>
                          </div>
                          <div style="margin-left : 5px;">
                            <button class="btn float-right btn btn-outline-success" type="submit" formaction="<?= base_url; ?>/Report/export_distribution_riemann_area"><i class = "fa fa-download"> Area Detail</i></button>
                          </div>
                      </div>
                        ...
                        <table id="distr" class="table table-bordered table-sm" align="left" style="font-size:85%; border: 1px solid black;table-layout: fixed;">
                          <thead class="table-warning">
                            ...
                            <tr style="line-height: 12px; vertical-align: middle;">
                              ...
                              <th colspan="2" class="text-center" style="width: 55px;vertical-align: middle;"><?= $row['item_name'];?></th>
                              <?php endforeach ?>  
                            </tr>                  
