  ...
  <div class="content-wrapper">
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
            ...
            ?>
            <h1>Contribution Summary - TOASTBOX (<?php echo $monthName1. ' To ' .$monthName2;?>)</h1> 
    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-body"> 
            <form action="<?= base_url; ?>/Report/contribution_toastbox" method="post">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        ?>
                          ...
                          <div style="margin-left : 5px;width : 155px;">
                            ...
                            <div style="margin-left : 5px;">
                              ...
                              <a class="btn btn-outline-secondary" href="<?= base_url; ?>/Report/contribution_toastbox">Reset</a>
                            </div>
                            <div style="margin-left : 5px;">
                              <button class="btn float-right btn btn-outline-success" type="submit" formaction="<?= base_url; ?>/Report/export_contribution_toastbox"><i class = "fa fa-download"> Excel</i></button>
                            </div>
                        ...
                        <div class="table-responsive-sm text-small">
                          ...
                          <thead class="table-warning">
                            ...
                            <?php $channel=''; ?>
                                ...
                                <!-- Online -->
                                <?php foreach ($data['cont_toastbox'] as $row) :?>
                                ...
                                <tr>
                                    ...
                                    <td class="text-right"><?= number_format($row['total_val'], 2);?></td>
