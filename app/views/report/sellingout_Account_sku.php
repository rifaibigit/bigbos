  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Report Selling Out - By Group Account & SKU</h1> 
    ...
    <section class="content">
        ...
        <div class="card">
            <div class="card-body"> 
                <form action="<?= base_url; ?>/Report/Sellingout_Account_SKU" method="post">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="input-group mb-3">
                                ...
                                ?>
                                    ...
                                    <div style="margin-left : 5px; margin-bottom: 5px;">
                                        ...
                                        <a class="btn btn-outline-secondary" href="<?= base_url; ?>/Report/Sellingout_Account_SKU">Reset</a>
                                    </div>
                                    <div style="margin-left : 5px; margin-bottom: 5px;">
                                        <button class="btn float-right btn btn-outline-success" type="submit" formaction="<?= base_url; ?>/Report/export_sellingout_Account_SKU"><i class = "fa fa-download"> Excel</i></button>
                                    </div>
                            </div>
                                    ...
                                    <thead class="table-warning">
                                        ...
                                        <tr style="line-height: 10px; vertical-align: middle;">
                                            <?php for($i=1;$i<=$count;$i++){
                                                echo '<th class="text-center" style="width: 30px; vertical-align: middle;white-space: nowrap">Qty</th>';
                                                echo '<th class="text-center" style="width: 15px; vertical-align: middle;">Value</th>';
                                            } 
                                            ?> 
                                            <th class="text-center" style="width: 30px; vertical-align: middle; background-color: #fd9191ff;white-space: nowrap">Qty</th>
                                            <th class="text-center" style="width: 15px; vertical-align: middle; background-color: #fd9191ff;">Value</th>
                                            <th class="text-center" style="width: 30px; vertical-align: middle; background-color: #fd9191ff;white-space: nowrap">Qty</th>
                                            <th class="text-center" style="width: 15px; vertical-align: middle; background-color: #fd9191ff;">Value</th>
                                        </tr>
                                    </thead>
