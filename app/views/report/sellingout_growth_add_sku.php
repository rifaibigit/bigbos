  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Report Selling Out - Growth Add SKU</h1> 
    ...
    <section class="content">
        ...
        <div class="card">
            <div class="card-body"> 
                <form action="<?= base_url; ?>/Report/Sellingout_Growth_Add_SKU" method="post">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="input-group mb-3">
                                ...
                                ?>
                                    ...
                                    <div style="margin-left : 5px; margin-bottom: 5px;">
                                        ...
                                        <a class="btn btn-outline-secondary" href="<?= base_url; ?>/Report/Sellingout_Growth_Add_SKU">Reset</a>
                                    </div>
                                    <div style="margin-left : 5px; margin-bottom: 5px;">
                                        <button class="btn float-right btn btn-outline-success" type="submit" formaction="<?= base_url; ?>/Report/export_sellingout_growth_add_sku"><i class = "fa fa-download"> Excel</i></button>
                                    </div>
                            </div>
                            ...
                            <div class="table-responsive-sm text-small">
                                <table id="sale_out_growth_exist" class="table table-bordered table-sm" align="left" style="font-size:85%; border: 1px solid black;table-layout:fixed;">
                                    ...
                                    <tbody>
                                        ...
                                        <?php foreach ($data['sellingout_add_sku'] as $row) :?>
                                            ...
                                            $sub_value += $row['value_add_sku'];
                                            $total_value += $row['value_add_sku'];
