  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Report Selling Out - Growth by Outlet Type</h1> 
                </div>
            </div>
        </div><!-- /.container-fluid -->
    </section>
    ...
    <section class="content">
        ...
        <div class="card">
            <div class="card-body"> 
                <form action="<?= base_url; ?>/Report/sellingout_growth_outlet_type" method="post">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="input-group mb-3">
                                ...
                                <?php
                                    ...
                                    foreach ($data['so_growth_outlet_type'] as $row):
                                ...
                                ?>
                                    ...
                                    <div>
                                        ...
                                        <a class="btn btn-outline-secondary" href="<?= base_url; ?>/Report/sellingout_growth_outlet_type">Reset</a>
                                        <button class="btn float-right btn btn-outline-success" type="submit" style="margin-left : 20px;" formaction="<?= base_url; ?>/Report/export_sellingout_growth_outlet_type"><i class = "fa fa-download"> Excel</i></button>
                                    </div>
                            </div>

                            <!-- <div id="hasil_sale_out"></div> -->
                            <div class="table-responsive-sm text-small">
                                <table id="so_growth_channel" class="table table-bordered table-sm" align="left" style="font-size:85%; border: 1px solid black;table-layout:fixed;">
                                    <thead class="table-warning">
                                        <tr>
                                            <th rowspan="2" class="text-center" style="width: 5px; vertical-align: middle;">#</th>
                                            <th rowspan="2" class="text-center" style="width: 170px; vertical-align: middle;">Outlet Type</th>
                                    ...
                                    <tbody>
                                        ...
                                        <?php foreach ($data['so_growth_outlet_type'] as $row) :?>
                                            ...
                                            <?php
                                                ...
                                                if ($channel != $row['channel'] and $channel != '' )
                                                {
                                                    ...
                                                    echo '<tr class="table-warning" style="font-weight:bold;">';
                                                        // echo '<td></td>';
                                                        echo '<td colspan="3" class="text-center">' . $channel . '</td>';
                                        ...
                                        <tr class="table-warning" style="font-weight:bold;">
                                            <!-- <td></td> -->
                                            <td colspan="3" class="text-center"><?= $channel;?></td>
