  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Report Selling In - Performance</h1> 
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
    ...
    <section class="content">
      ...
      <div class="card">
        ...
        <div class="card-body"> 
            <form action="<?= base_url; ?>/Report/sellingin_performance" method="post">
                <div class="row">
                    <div class="col-md-12">
                      <div class="input-group mb-3">
                        ...
                        ?>
                          ...
                          <div style="margin-left : 5px;width : 155px;">
                            <select class="select2-multiple2 md-form md-form form-control" title="By Area" name="by_area[]" id="dt_area" style="margin-left : 10px;width : 155px;" multiple="multiple">
                          ...
                          <div style="margin-left : 10px;">
                            ...
                            <a class="btn btn-outline-secondary" href="<?= base_url; ?>/Report/sellingin_performance" onclick="openLoader()">Reset</a>
                          </div>
                          <div style="margin-left : 10px;">
                            <button class="btn float-right btn btn-outline-success" type="submit" formaction="<?= base_url; ?>/Report/export_sellingin_performance"><i class = "fa fa-download"> Excel</i></button>
                            <!-- <button class="btn float-right btn btn-outline-success" id="export" type="button"><i class = "fa fa-download"> Excel</i></button> -->
                          </div>
                        </div>
                        ...
                        <div class="table-responsive-sm text-small">
                          ...
                          <thead class="table-warning">
                              <tr>
                                ...
                                <th rowspan="3" class="text-center" style="width: 15px; vertical-align: middle;">Principal</th>
                                <th rowspan="3" class="text-center" style="width: 90px; vertical-align: middle;">Group SKU</th>
                                <th rowspan="3" class="text-center" style="width: 8px; vertical-align: middle;">Kode Item</th>
...
<!-- <script>
  $('#export').click(function(){
    let table = document.getElementsByID("sale_in_performance");
