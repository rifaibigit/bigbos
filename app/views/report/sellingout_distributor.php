...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Report Selling Out - Distributor</h1> 
                </div>
            </div>
        </div><!-- /.container-fluid -->
    </section>
    ...
    <section class="content">
        ...
        <div class="card">
            <div class="card-body"> 
                <form action="<?= base_url; ?>/Report/sellingout_distributor" method="post">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="input-group mb-3">
                                ...
                                ?>
                                    ...
                                    <div style="margin-left : 10px;">
                                        ...
                                        <a class="btn btn-outline-secondary" href="<?= base_url; ?>/Report/sellingout_distributor">Reset</a>
                                    </div>
                                    <div style="margin-left : 10px;">
                                        <button class="btn btn-outline-success" type="submit" formaction="<?= base_url; ?>/Report/export_sellingout_dist"><i class = "fa fa-download"> Excel</i></button>
                            ...
                            <div class="table-responsive-sm text-small">
                                <table id="sale_out_distributor" class="table table-bordered table-sm nowrap" align="left" style="font-size:85%; border: 1px solid black;table-layout:fixed;">
                                <thead class="table-warning">
                                        ...
                                        <tr>
                                            ...
                                            <!-- <th colspan="2" class="text-center" style="width: 160px">Total</th>
                                            <th colspan="2" class="text-center" style="width: 160px">Average</th> -->
                                        </tr>
                                    ...
                                    <tbody>
                                        ...
                                        <?php foreach ($data['sellingout_Dist'] as $row) :?>
                                        ...
                                        <tr>
                                            ...
                                            <?php
                                                $data1 = array(
                                                    'principal' => $principal,
                                                    'dist_code' => str_replace(" ", "*_*", $row['cust_code']),
                                                    'month' => '1',
                                                    'year' => $year,
                                            ...
                                            <td class="text-right"><b><a href="<?= base_url; ?>/Report/sellingout_RAW2/<?= implode(",", $data1); ?>" target="_blank"><?= number_format($row['val_jan'], 2);?></a></b></td>
                                            <td class="text-right"><?= number_format($row['qty_feb'], 2);?></td>
                                            <td class="text-right"><b><a href="<?= base_url; ?>/Report/sellingout_RAW2/<?= implode(",", $data2); ?>" target="_blank"><?= number_format($row['val_feb'], 2);?></a></b></td>
                                            <td class="text-right"><?= number_format($row['qty_mar'], 2);?></td>
                                            <td class="text-right"><b><a href="<?= base_url; ?>/Report/sellingout_RAW2/<?= implode(",", $data3); ?>" target="_blank"><?= number_format($row['val_mar'], 2);?></a></b></td>
                                            <td class="text-right"><?= number_format($row['qty_apr'], 2);?></td>
                                            <td class="text-right"><b><a href="<?= base_url; ?>/Report/sellingout_RAW2/<?= implode(",", $data4); ?>" target="_blank"><?= number_format($row['val_apr'], 2);?></a></b></td>
                                            <td class="text-right"><?= number_format($row['qty_mei'], 2);?></td>
                                            <td class="text-right"><b><a href="<?= base_url; ?>/Report/sellingout_RAW2/<?= implode(",", $data5); ?>" target="_blank"><?= number_format($row['val_mei'], 2);?></a></b></td>
                                            <td class="text-right"><?= number_format($row['qty_jun'], 2);?></td>
                                            <td class="text-right"><b><a href="<?= base_url; ?>/Report/sellingout_RAW2/<?= implode(",", $data6); ?>" target="_blank"><?= number_format($row['val_jun'], 2);?></a></b></td>
                                            <td class="text-right"><?= number_format($row['qty_jul'], 2);?></td>
                                            <td class="text-right"><b><a href="<?= base_url; ?>/Report/sellingout_RAW2/<?= implode(",", $data7); ?>" target="_blank"><?= number_format($row['val_jul'], 2);?></a></b></td>
                                            <td class="text-right"><?= number_format($row['qty_agu'], 2);?></td>
                                            <td class="text-right"><b><a href="<?= base_url; ?>/Report/sellingout_RAW2/<?= implode(",", $data8); ?>" target="_blank"><?= number_format($row['val_agu'], 2);?></a></b></td>
                                            <td class="text-right"><?= number_format($row['qty_sep'], 2);?></td>
                                            <td class="text-right"><b><a href="<?= base_url; ?>/Report/sellingout_RAW2/<?= implode(",", $data9); ?>" target="_blank"><?= number_format($row['val_sep'], 2);?></a></b></td>
                                            <td class="text-right"><?= number_format($row['qty_okt'], 2);?></td>
                                            <td class="text-right"><b><a href="<?= base_url; ?>/Report/sellingout_RAW2/<?= implode(",", $data10); ?>" target="_blank"><?= number_format($row['val_okt'], 2);?></a></b></td>
                                            <td class="text-right"><?= number_format($row['qty_nop'], 2);?></td>
                                            <td class="text-right"><b><a href="<?= base_url; ?>/Report/sellingout_RAW2/<?= implode(",", $data11); ?>" target="_blank"><?= number_format($row['val_nop'], 2);?></a></b></td>
                                            <td class="text-right"><?= number_format($row['qty_des'], 2);?></td>
                                            <td class="text-right"><b><a href="<?= base_url; ?>/Report/sellingout_RAW2/<?= implode(",", $data12); ?>" target="_blank"><?= number_format($row['val_des'], 2);?></a></b></td>
                                            <td class="text-right"><?= number_format($row['qty_year'], 2);?></td>
                                            <td class="text-right"><b><a href="<?= base_url; ?>/Report/sellingout_RAW2/<?= implode(",", $data_year); ?>" target="_blank"><?= number_format($row['val_year'], 2);?></a></b></td>
