    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-body">
          <div class="row">
            <div class="col-sm-6">
              <form action="<?= base_url; ?>/TargetSO/importExcel" enctype="multipart/form-data" method="POST" role="form">
                <div class="row">
                  <div class="col-xs-5">
                    <div class="input-group mb-3">
                      ...
                      <div style="margin-left: 5px;">
                        <a href="<?= base_url; ?>/app/upload/Format Upload Target Selling Out.xlsx" class="btn float-right btn btn-outline-success"><i class = "fa fa-download"></i></a>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div class="col-sm-6" style="display: flex; justify-content: flex-end">
                <form action="<?= base_url; ?>/TargetSO" enctype="multipart/form-data" method="POST" role="form">
                  <?php
                      if(isset($data))
                      {
                          $month = $data['by_month'];
                  ...
                  <div class="row">
                    <div class="input-group mb-3">
                      ...
                      <div style="margin-left : 5px;">
                          ...
                          <a class="btn btn-outline-secondary" href="<?= base_url; ?>/TargetSO">Reset</a>
                      </div>
                    </div>
                  </div>
                </form>
          ...
          <div class="table-responsive-xs text-small">
            <table id="target_so" class="table table-bordered nowrap" style="font-size:80%; border: 1px solid black; width: 100%;">
              ...
              <tbody>
                  <?php $no=1; ?>
                  <?php foreach ($data['targetSO'] as $row) :?>
                  <tr>
        ...
        else
        {
          Swal.fire({
            ...
            if (result.value) {
              $.ajax({
                type: 'POST',
                url:  '<?= base_url; ?>/TargetSO/importExcel2',
                data: {json:json},
                beforeSend: function() {
                  Swal.fire({
                    title: 'Uploading...',
                ...
                success:function(response){
                  Swal.fire({
                      ...
                      window.location = "<?= base_url; ?>/TargetSO";
                  });
                },
