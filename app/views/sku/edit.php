...
<div class="card card-primary">
              ...
              <form role="form" action="<?= base_url; ?>/Sku/updateSku" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <label >Unit</label>
                        <input type="text" class="form-control" placeholder="masukkan Unit..." name="unit" value="<?= $data['sku']['unit']; ?>" >
                        <input type="text" class="form-control"  name="edit_by" value="<?= $_SESSION['username'];?>" hidden>
                    </div>
                    <div class="form-group">
