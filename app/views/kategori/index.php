            ...
            <tbody>
              ...
              <?php foreach ($data['kategori'] as $row) :?>
                <tr>
                  ...
                  <td>
                    <a href="<?= base_url; ?>/kategori/edit/<?= $row['id'] ?>" class="badge badge-pill badge-info ">Edit</a> <a href="<?= base_url; ?>/kategori/hapus/<?= $row['id'] ?>" class="badge badge-pill badge-danger" onclick="return confirm('Hapus data?');">Hapus</a>
                  </td>
                </tr>
              <?php $no++; endforeach; ?>
            </tbody>
