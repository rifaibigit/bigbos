...
class TargetSO extends Controller {
	...
	public function index()
	{
		...
		$data['targetSO'] = $this->model('TargetSOModel')->getAllTarget();
		$this->template('header', $data);
		$this->template('sidebar', $data);
		$this->view('target_so/index', $data);
	...
	public function show()
	{
		...
		$data['data'] = $this->model('TargetSOModel')->getAllTarget();
	...
	public function cari()
	{
		...
		$data['sellingout'] = $this->model('TargetSOModel')->cariSellingout();
		$data['key'] = $_POST['key'];
		$this->template('header', $data);
		$this->template('sidebar', $data);
	...
	public function edit($id){
		...
		$data['sellingout'] = $this->model('TargetSOModel')->getSellingoutById($id);
		$this->template('header', $data);
		$this->template('sidebar', $data);
	...
	public function tambah(){
		...
		$data['sellingout'] = $this->model('TargetSOModel')->getAllTarget();		
		$this->template('header', $data);
		$this->template('sidebar', $data);
	...
	public function importExcel()
    {
        if(isset($_POST['save']))
        {
			...
			{                                  
				...
				$data['target'] = $this->model('TargetSOModel')->getDuplicateTargetSO($data1);
				...
				if($item_code != '')
				{
					$this->model('TargetSOModel')->updateTarget($data1);
					$update_count++;
				}
				else
				{
					$this->model('TargetSOModel')->tambahTarget($data1);
					$save_count++;
				}
	...
	public function importExcel2()
    {
        ...
        // {
			...
			$this->model('TargetSOModel')->uploadTargetSO($data1);
