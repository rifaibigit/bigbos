              ...
              <form role="form" action="<?= base_url; ?>/sku/simpanSku" method="POST" enctype="multipart/form-data">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <select class="mdb-select md-form form-control" title="By Group SKU" id="item_group" name="item_group" style="margin-left : 10px;">
                      <option value="">--</option>
                        <?php $no=1; ?>
                  ...
                  <div class="form-group">
                    ...
                    <select class="mdb-select md-form form-control" title="By Principal" id="principal" name="principal">
                      <option value="">--</option>
                        <?php $no=1; ?>
