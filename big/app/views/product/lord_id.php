<div class="py-5">
    <div class="container">
        <center><h6 class="section-title h2"><b>PRODUK LORD</b></h6></center>
        <br>
		<div class="row">
			<div class="col-sm-12" width="100%">
				<nav>
                    ...
                    <?php foreach($data['item_group'] as $row): ?>
                        <a class="nav-item nav-link <?php if($row['id']== '1'){echo('active');}; ?> " id="nav-<?= $row['id']; ?>-tab" data-toggle="tab" href="#nav-<?= $row['id']; ?>" role="tab" aria-controls="nav-<?= $row['id']; ?>" aria-selected="true"><b><?= $row['item_group']; ?></b></a>
                    <?php endforeach;?>
					</div>
				</nav>
				<div class="tab-content" id="nav-tabContent" style="margin-top:50px;">
                <?php foreach($data['item_group'] as $row): ?>
                    <div class="tab-pane fade<?php if($row['id']== '1'){echo(' show active');}; ?>" id="nav-<?= $row['id']; ?>" role="tabpanel" aria-labelledby="nav-<?= $row['id']; ?>-tab">
                        <div class="row">
                            ...
                            <div class="col-sm-3 wow fadeInLeft">
                                <div class="card-box" style="margin-left:10px;margin-right:10px;margin-top:10px;margin-bottom:10px;padding-top:10px;padding-bottom:10px;width:250px;height:270px;">
                                    <div class="card-body-flex" style="height:200px;">
                                        <a href="<?= base_url; ?>/Product/Detail_Lord_ID/<?= $row2['id']; ?>">
                                    ...
                                    <div class="card-footer-flex" style="margin-top: 10px;background-color:white;height:30px;">
                                        <center><h5><span class="badge badge-dark shadow" style="padding:10px;"><?= $row2['item_code']; ?></span></h5></center>
                                    </div>
                                    </a>
