      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-6 content">
            ...
            <h3>PT. Bintang Inter Global offers rental of chiller and freezers for drink and frozen food products.</h3>
            ...
            <a href="<?= base_url; ?>/About/about_rental" class="btn btn-info" role="button">Read more >></a>
          </div>
            ...
            <div class="col-sm-3 wow fadeInLeft">
                <div class="card-box" style="margin-left:10px;margin-right:10px;margin-top:10px;margin-bottom:10px;padding-top:10px;padding-bottom:10px;width:250px;height:330px;">
                  <div class="card-body" style="height:220px;">
                    <a href="<?= base_url; ?>/Product/Fridge/<?= $row['id'];?>">
        ...
        <!-- <div class="section-body">
            <div class="row">
              <div class="col-md-1 mx-auto">
                <center><img src="<?= base_url; ?>/dist/img/client/belfoods.png" alt=""></center>
              </div>
              <div class="col-md-1 mx-auto">
                <center><img src="<?= base_url; ?>/dist/img/client/danone.png" alt=""></center>
              </div>
              <div class="col-md-1 mx-auto">
                <center><img src="<?= base_url; ?>/dist/img/client/BK.png" alt=""></center>
              </div>
              <div class="col-md-1 mx-auto">
               <center><img src="<?= base_url; ?>/dist/img/client/nestle.png" alt=""></center>
              </div>
              <div class="col-md-1 mx-auto">
                <center><img src="<?= base_url; ?>/dist/img/client/cp prima.png" alt=""></center>
              </div>
              <div class="col-md-1 mx-auto">
                <center><img src="<?= base_url; ?>/dist/img/client/knm.png" alt=""></center>
              </div>
              <div class="col-md-1 mx-auto">
                <center><img src="<?= base_url; ?>/dist/img/client/sreeya.png" alt=""></center>
              </div>
              <div class="col-md-1 mx-auto">
                <center><img src="<?= base_url; ?>/dist/img/client/sekar.png" alt=""></center>
              </div>
              <div class="col-md-1 mx-auto">
                <center><img src="<?= base_url; ?>/dist/img/client/jala.png" alt=""></center>
              </div>
              <div class="col-md-1 mx-auto">
                <center><img src="<?= base_url; ?>/dist/img/client/kml.png" alt=""></center>
              </div>
            </div>
        </div> -->
