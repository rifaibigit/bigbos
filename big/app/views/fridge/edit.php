  ...
  <div class="content-wrapper">
    ...
    <section class="content">
          <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" action="<?= base_url; ?>/Fridge/updateFridge" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    <label>Name</label>
                    <input type="text" class="form-control" placeholder="masukkan Kode..." name="item_name" value="<?= $data['sku']['item_name']; ?>" readonly> 
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    <label>Picture</label>
                    <br>
                    <img src="<?= base_url; ?>/dist/img/freezer n chiller/<?= $data['sku']['img'] ;?>" id="preview" class="img-thumbnail" style="width:165px; height:243px;background-color:grey;margin-bottom:10px;">
                  ...
                  <div class="form-group">
                    ...
                    <select class="mdb-select md-form form-control" title="Type" id="item_group" name="item_group">
                        <option value="">--</option>
                        <option <?php if( $data['sku']['item_group']=='Chiller'){echo "selected"; } ?> value="Chiller">Chiller</option>
                        <option <?php if( $data['sku']['item_group']=='Freezer'){echo "selected"; } ?> value="Freezer">Freezer</option>
                      </select>
                  </div>
                </div>
                <!-- /.card-body -->
