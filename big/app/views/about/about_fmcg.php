            ...
            <div class="flip-box" style="margin-top:20px;">
              <div class="flip-box-inner">
                <div class="flip-box-front" style="padding:30px;">
                  <h2>Vision</h2>
                  <p>
                    PT. Bintang Inter Global are dedicated to becoming a public company in the field of Chiller & Freezer providers and all equipment for food and drink industry with full service coverage that meets customer needs in the Asia Pacific in 2020.
                  </p>
                </div>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-6 content">
            ...
            <p>
              PT. Bintang Inter Global is a company engaged in the Freezer & Chiller Operation System and as the principal Jordan Brand Brush & Toothpaste, Lord Shaver and we also have a Group Office, namely PT Mitra Adikarya Solusindo (Semi Distributor of Multi Food & Soft Drink Products) and PT Bintang Multi Global.
            </p>
        ...
        <div class="row contact-info">
          ...
          <div class="col-md-4">
            <div class="contact-phone">
              ...
              <h3>Phone Number</h3>
              <p>
                <a href="tel:+622129573940">+62-21-2957-3940</a>
              </p>
            </div>
          </div>
          ...
          <div class="col-md-4">
            <div class="contact-email">
              ...
              <h3>Email</h3>
              <p>
                <a href="mailto:mkt@bintanginterglobal.com">mkt@bintanginterglobal.com</a>
              </p>
            </div>
          </div>
